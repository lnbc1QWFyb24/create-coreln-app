...
function drawRainbow(numColors, startColor, y1, y2) {
  ...
  let rainbowGradient = ctx.createLinearGradient(centerX, centerY - 40, canvas.width - 25, canvas.height - 150);
  let colorStop = 0;
...
<canvas bind:this="{canvas}" style="position: absolute; top: 0; left: 0; height: {window.innerHeight}px;"></canvas>
